...
{
    private Dictionary<MonoPriority, List<MonoBase>> monoBases = new Dictionary<MonoPriority, List<MonoBase>>();
    ...
    /// </summary>
    /// <param name="mb"></param>
    public void RegisterMonoObject(MonoBase mb)
    {
        if(mb != null)
    ...
    /// </summary>
    /// <param name="mb"></param>
    public void DisposeMonoObject(MonoBase mb)
    {
        if(mb != null)
